...
Using a subset of the ```blood``` data set we compare sinaplot with boxplot,
violinplot and beeswarm, and show how our package integrates features from these
plotting methods to achieve truthful and yet simple representation of multiclass
